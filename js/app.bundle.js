...
throw new Error("Cannot find module \"node-modules/angular-material\"");


__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"npm/bootstrap/dist/css/bootstrap.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));



var restApp = angular.module('restApp', ['ngAria','ngMessages','jsonFormatter']);
